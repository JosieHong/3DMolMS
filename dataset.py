...
LastEditors: yuhhong
LastEditTime: 2022-12-09 20:13:25
'''
import torch
...
class BaseDataset(Dataset): 
	...
	def parse_collision_energy(self, ce_str, pepmass, charge=2): 
		...
		ce = None
		if ce_str in self.ENCODE_CE.keys(): # all the ce of GNPS is 'unknow' 
...
class MERGEDataset(BaseDataset): 
	def __init__(self, supp, gzsupp, num_points=200, num_ms=2000, resolution=1, data_augmentation=False): 
		...
		self.MAP_INST = {# NIST20
							...
							# GNPS
							'esi-qtof': 'QTOF', 'lc-esi-qtof': 'QTOF', 'esi-lc-esi-qtof': 'QTOF', 
							...
							# MassBank
							'lc-esi-qft hcd': 'HCD', 'lc-esi-itft hcd': 'HCD', 
